...
class NoAuthToken(APIException):
    ...
    default_detail = 'Authorization credentials not provided'
...
class FirebaseError(APIException):
    ...
    default_detail = 'The user provided with the authentication token is not a valid Firebase user (Firebase UID not found)'
